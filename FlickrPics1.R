...
year<-seq(2015,2017,1)                  #creates variable "year" so that query returns pictures taken between 2005 and 2014
text<-"nature"                            #set keywords so that query returns pictures with the text "bird"
woeid<-"10243"                       #only return pictures taken in Scotland
...
write.table(pics, "NaturePics.txt", row.names = F)
